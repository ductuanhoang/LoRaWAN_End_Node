...
static void SendTxData(void)
{
  ...
  // APP_LOG(TS_ON, VLEVEL_M, "hdc temperature: %d\r\n", (int16_t)(hdc1080_data.temperature));
  // APP_LOG(TS_ON, VLEVEL_M, "hdc humidity: %d\r\n", (int16_t)(hdc1080_data.humidity));
